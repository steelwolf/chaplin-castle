...
// Add custom stuff to Chaplin metas
// Post meta: Add the reading_time post meta item to the end of the single top and archive post meta
function chaplin_child_post_meta_add_reading_time( $post_meta, $location ) {

	if ( in_array( $location, array( 'archive', 'single-top' ) ) ) {
		$post_meta[] = 'reading-time';
	}

	return $post_meta;

}
add_filter( 'chaplin_post_meta_items', 'chaplin_child_post_meta_add_reading_time', 10, 2 );

// Post meta: Output the modified_date post meta item
function chaplin_child_post_meta_output_reading_time( $post_id, $location ) {
	global $has_meta;
	$has_meta = true;
	?>
	<li class="post-date meta-wrapper">
		<span class="meta-icon">
			...
			<?php chaplin_the_theme_svg( 'text' ); ?>
		</span>
		<span class="meta-text">
			<?php printf( __( 'Read time: %s', 'chaplin-child' ), reading_time() ); ?>
		</span>
	</li>
	<?php
}
add_action( 'chaplin_post_meta_reading-time', 'chaplin_child_post_meta_output_reading_time', 10, 3 );
...
if ( ! class_exists( 'Chaplin_SVG_Icons' ) ) :
  ...
  <path fill="#1A1A1B" d="M1148.0319,95.6176858 L1151.70711,99.2928932 C1152.09763,99.6834175 1152.09763,100.316582 1151.70711,100.707107 C1151.31658,101.097631 1150.68342,101.097631 1150.29289,100.707107 L1146.61769,97.0318993 C1145.07801,98.2635271 1143.12501,99 1141,99 C1136.02944,99 1132,94.9705627 1132,90 C1132,85.0294372 1136.02944,81 1141,81 C1145.97056,81 1150,85.0294372 1150,90 C1150,92.1250137 1149.26353,94.078015 1148.0319,95.6176858 Z M1146.04139,94.8563911 C1147.25418,93.5976949 1148,91.8859456 1148,90 C1148,86.1340067 1144.86599,83 1141,83 C1137.13401,83 1134,86.1340067 1134,90 C1134,93.8659933 1137.13401,97 1141,97 C1142.88595,97 1144.59769,96.2541764 1145.85639,95.0413859 C1145.88271,95.0071586 1145.91154,94.9742441 1145.94289,94.9428932 C1145.97424,94.9115423 1146.00716,94.8827083 1146.04139,94.8563911 Z" transform="translate(-1132 -81)"/>
</svg>',
  ...
  <path d="M18 3v2H2V3h16zm-6 4v2H2V7h10zm6 0v2h-4V7h4zM8 11v2H2v-2h6zm10 0v2h-8v-2h8zm-4 4v2H2v-2h12z" fill="#1A1A1B"/>
</svg>',
