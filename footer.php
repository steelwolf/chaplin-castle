		...
		if ( ! is_page_template( $only_content_templates ) || $show_footer ) : ?>
			...
			<footer id="site-footer" role="contentinfo">
              ...
              <span class="footer-icons creative-commons color-accent-hover">
                <a href="https://creativecommons.org/licenses/by-sa/4.0/"></a>
              </span>
              <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC-BY-SA</a> 2004–<?php echo esc_html( date_i18n( __( 'Y', 'chaplin' ) ) ); ?> <a href="<?php echo esc_url( home_url() ); ?>" rel="home"><?php echo bloginfo( 'name' ); ?></a>
            </p>
						<p class="theme-credits color-secondary">
							<?php
							/* Translators: $s = name of the theme developer */
							printf( esc_html_x( 'Modifications of an original theme by %s.', 'Translators: $s = name of the theme developer', 'chaplin' ), '<a href="https://www.andersnoren.se">' . esc_html__( 'Anders Nor&eacute;n', 'chaplin' ) . '</a>' ); ?>
						</p><!-- .theme-credits -->
